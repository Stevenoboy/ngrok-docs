...
>
> Tunnel configurations are still supported in the new `v3` configuration file format. However, they're being deprecated in favor of endpoints, which provide a simpler and more powerful way of managing ingress. If you wish to see documentation on how to enable and configure tunnels, please refer to the [Tunnel Configuration](/docs/agent/config/v2#tunnel-configurations) section.
